...
public class RegisteredPhonesResolver<T: GigyaAccountProtocol>: TFAResolver<T>, IOCRegisteredEmailsResolver {
    ...
    public func sendEmailCode(with email: TFAEmail, completion: @escaping (RegisteredEmailsResult) -> Void) {
        var params: [String: String] = [:]
...
public enum RegisteredEmailsResult {
    ...
    case emailVerificationCodeSent(resolver: IOCVerifyCodeResolver)

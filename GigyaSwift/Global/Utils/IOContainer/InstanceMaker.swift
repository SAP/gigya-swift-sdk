...
class ServiceMaker<T> {
    ...
    // TODO: move make service in resolve
//    private func makeInstanceAsSingltoneIfNeeded() {
//        guard isSingleton == true, let container = resolver else { return }
//
//        singletonInstance = method(container)
//        method = { _ in return self.singletonInstance! }
//    }
}
